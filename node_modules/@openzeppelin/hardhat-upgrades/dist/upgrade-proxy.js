        ...
        if ((0, upgrades_core_1.isEmptySlot)(adminAddress) || adminBytecode === '0x') {
            ...
            return (nextImpl, call) => {
                if (upgradeInterfaceVersion === undefined) {
                    ...
                    throw new Error(`Unknown UPGRADE_INTERFACE_VERSION ${upgradeInterfaceVersion} for proxy at ${proxyAddress}. Expected 5.0.0`);
                }
            };
        }
        else {
            ...
            return (nextImpl, call) => {
                if (upgradeInterfaceVersion === undefined) {
                    ...
                    throw new Error(`Unknown UPGRADE_INTERFACE_VERSION ${upgradeInterfaceVersion} for proxy admin at ${adminAddress}. Expected 5.0.0`);
                }
            };
        }
    }
